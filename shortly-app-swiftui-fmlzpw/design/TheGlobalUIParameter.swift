...
struct TheGlobalUIParameter {
  ...
  static let more_slowly_animation_duration = TimeInterval(1.3)
  static let slow_animation_duration = TimeInterval(1.0)
  static let snappy_animation_duration = TimeInterval(0.5)
  static let snappier_animation_duration = TimeInterval(0.2)
  ...
  static let the_position_of_new_URLSession_message_in_percent = CGFloat(0.11) /// < the_position_of_error_message_from_the_web_endpoint_in_percent: The below can **NOT** be the same.
